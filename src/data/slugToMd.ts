...
const _slugToMd: { [slug: string]: string } = {
  ...
  'push-and-pickle': pushAndPickle,
  'hi-doggy': hiDoggy,
  'proto-grader': protoGrader,
  'navigating-the-digital-labyrinth': navigatingTheDigitalLabyrinth,
  'language-labyrinth-and-graphicsmagick': languageLabyrinthAndGraphicsMagick,
  'digging-up-history': diggingUpHistory,
  alligatorpay: alligatorPay,
  'hardware-isnt-that-hard': hardwareIsntThatHard,
  noncevigator: noncevigator,
